      ...
      <div className="container mx-auto px-4 py-8">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-yellow-300 text-sm font-mono">
                    {user.custody ? `${user.custody.slice(0, 6)}...${user.custody.slice(-4)}` : 'Not connected'}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-300">{gameStats.totalGames}</div>
                <div className="text-sm opacity-75">Games Played</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-300">{gameStats.bestScore.toLocaleString()}</div>
                <div className="text-sm opacity-75">Best Score</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-300">{gameStats.totalTokens}</div>
                <div className="text-sm opacity-75">Total Tokens</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-300">{formatPlayTime(gameStats.totalPlayTime)}</div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-yellow-300">{settings.controlSensitivity}/10</span>
                </div>
                <input
                  type="range"
                  min="1"
        ...
        <div className="mt-8 space-y-3">
          <Link href="/game" className="block">
            <button className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-6 rounded-lg transition-colors">
              🎮 Play Game
            </button>
          </Link>
