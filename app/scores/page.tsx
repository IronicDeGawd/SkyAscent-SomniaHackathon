...
export default function ScoresPage() {
  ...
  useEffect(() => {
    const loadScores = async () => {
      try {
        // TODO: Load from blockchain contract
        ...
        setPlayerHistory([
          { score: 8500, altitude: 1500, gameTime: 180, timestamp: Date.now() - 86400000 },
          { score: 6200, altitude: 1200, gameTime: 150, timestamp: Date.now() - 172800000 },
          { score: 4800, altitude: 900, gameTime: 120, timestamp: Date.now() - 259200000 },
        ])
